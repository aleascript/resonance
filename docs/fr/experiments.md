...
Regard peut à son tour servir à construire des jeux. Ses implémentations actuelles comprennent [Glorantha Perspectives](https://github.com/aleascript/glorantha-perspectives) et [Scooby-Doo](https://github.com/aleascript/scooby-doo).
...
Il **n'utilise pas Regard**. Son existence montre volontairement que Resonance peut conduire à des architectures de jeu différentes lorsque l'expérience recherchée l'exige.

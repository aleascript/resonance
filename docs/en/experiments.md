...
Regard can in turn be used to build games. Current implementations include [Glorantha Perspectives](https://github.com/aleascript/glorantha-perspectives) and [Scooby-Doo](https://github.com/aleascript/scooby-doo).
...
It does **not** use Regard. Its existence is deliberate evidence that Resonance can lead to different game architectures when the intended experience demands them.
